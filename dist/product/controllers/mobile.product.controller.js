...
exports.MobileProductController = void 0;
    ...
    constructor() {
        ...
        this.getOne = async (req, res) => {
            try {
                ...
                const product = await product_model_1.Product.findOne({ ...query, isActive: true }).lean();
                if (!product)
                ...
                const resolvedVariants = (product.variants ?? []).map((v) => {
                    ...
                    const attributesResolved = pairs.map((pair) => {
                        const attrInfo = attrById.get(pair.attributeId) ??
...
exports.MobileProductController = MobileProductController;
exports.default = MobileProductController;
